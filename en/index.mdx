...
<CardGroup cols={2}>
  ...
  <Card title="Online checking" icon="cloud" href="/en/online-checking">
    Planned for the end of 2026: evaluate instructions without installing the application locally and export reports in multiple formats.
  </Card>
  <Card title="Document summary" icon="file-alt" href="/en/summary">
    Generate a concise summary of the evaluation results for a whole document, useful for quick overviews and reporting.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Generate a summary">
    After evaluation, click **Generate Summary** to obtain a high‑level overview of the document’s compliance and key findings.
  </Step>
</Steps>
...
<CardGroup cols={2}>
  ...
  <Card title="Document summary" icon="file-alt">
    After an evaluation, generate a concise summary of the document’s overall compliance, highlighting major issues and strengths.
  </Card>
</CardGroup>